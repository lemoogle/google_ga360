view: ga_realtime_sessions_20170901 {
  sql_table_name: `43786092`.ga_realtime_sessions_20170901
    ;;
  ...
  dimension: export_time_usec {
    type: number
    sql: ${TABLE}.exportTimeUsec ;;
  }
...
view: ga_realtime_sessions_20170901__custom_dimensions {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_realtime_sessions_20170901__totals {
  dimension: bounces {
    type: number
    sql: ${TABLE}.bounces ;;
  }
...
view: ga_realtime_sessions_20170901__hits {
  dimension: app_info {
    hidden: yes
    sql: ${TABLE}.appInfo ;;
  }
...
view: ga_realtime_sessions_20170901__hits__custom_dimensions {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_realtime_sessions_20170901__hits__app_info {
  dimension: id {
    primary_key: yes
    type: string
    sql: ${TABLE}.id ;;
...
view: ga_realtime_sessions_20170901__hits__content_group {
...
view: ga_realtime_sessions_20170901__hits__content_info {
...
view: ga_realtime_sessions_20170901__hits__custom_variables {
...
view: ga_realtime_sessions_20170901__hits__custom_metrics {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_realtime_sessions_20170901__hits__experiment {
...
view: ga_realtime_sessions_20170901__hits__e_commerce_action {
...
view: ga_realtime_sessions_20170901__hits__promotion_action_info {
...
view: ga_realtime_sessions_20170901__hits__source_property_info {
...
view: ga_realtime_sessions_20170901__hits__item {
...
view: ga_realtime_sessions_20170901__hits__product__custom_dimensions {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_realtime_sessions_20170901__hits__product {
  dimension: custom_dimensions {
    hidden: yes
    sql: ${TABLE}.customDimensions ;;
  }
...
view: ga_realtime_sessions_20170901__hits__product__custom_metrics {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_realtime_sessions_20170901__hits__social {
...
view: ga_realtime_sessions_20170901__hits__event_info {
...
view: ga_realtime_sessions_20170901__hits__latency_tracking {
...
view: ga_realtime_sessions_20170901__hits__publisher {
...
view: ga_realtime_sessions_20170901__hits__page {
  dimension: hostname {
    type: string
    sql: ${TABLE}.hostname ;;
  }
...
view: ga_realtime_sessions_20170901__hits__transaction {
...
view: ga_realtime_sessions_20170901__hits__exception_info {
...
view: ga_realtime_sessions_20170901__hits__promotion {
...
view: ga_realtime_sessions_20170901__hits__refund {
...
view: ga_realtime_sessions_20170901__geo_network {
  dimension: city {
    type: string
    sql: ${TABLE}.city ;;
  }
...
view: ga_realtime_sessions_20170901__traffic_source {
...
view: ga_realtime_sessions_20170901__traffic_source__adwords_click_info {
...
view: ga_realtime_sessions_20170901__traffic_source__adwords_click_info__targeting_criteria {
...
view: ga_realtime_sessions_20170901__device {
  dimension: browser {
    type: string
    sql: ${TABLE}.browser ;;
  }
